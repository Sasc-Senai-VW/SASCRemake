  ...
  return (
    <>
      <div id="home">
        ...
        <a
          href="https://borainvestir.b3.com.br/noticias/esg/entenda-o-que-sao-e-como-funcionam-os-creditos-de-carbono/?gclid=CjwKCAiAtt2tBhBDEiwALZuhAHNnTDsRPruf4xOdpa95JPU9WdRXyzqgn-NW3MmdkjOM8SuoAsiHeBoCxwAQAvD_BwE"
          target="_blank"
        >
          <div className="linhasHome" id="frameCredito">
            {" "}
          </div>
        </a>
      </div>
